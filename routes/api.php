...
Route::post('driver-phone-number-check', [PassportController::class,'driverphoneNumberCheck']);
...
Route::post('register-delivery', [PassportController::class,'registerdelivery']);
...
Route::group(['prefix' => 'personal', 'middleware' => 'personal'], function(){
    Route::post('orderlist', [PersonalController::class,'orderlist']);
    ...
    Route::get('wallet', [PersonalController::class,'wallet']);
...
Route::group(['prefix' => 'delivery', 'middleware' => 'auth:api'], function(){
    ...
    Route::post('prefered-area-list-add',[PassportController::class,'preferedAreaListAdd']);
